...
namespace Monopoly_Server
{
    public partial class Server : Form
    {
        ...
        public void SetUpServer()
        {
            ...
            AddToListProcess("Setting up the game server...");
            // Set up the server.
            m_serverSocket.Bind(new IPEndPoint(IPAddress.Any, 4444));
            m_serverSocket.Listen(1);
            m_serverSocket.BeginAccept(new AsyncCallback(AcceptCallback), null);
        }
        private void AddToListProcess(string message)
        {
            if (lst_process.InvokeRequired)
            {
                lst_process.Invoke(new MethodInvoker(delegate
                {
                    lst_process.Items.Add(message);
                }));
            }
            else
            {
        ...
        private void AcceptCallback(IAsyncResult AR)
        {
            ...
            AddToListProcess("Client connected!");
        ...
        private void ReceiveCallback(IAsyncResult AR)
        {
            ...
            try
            {
                ...
                AddToListProcess("Command received from " + command.Name);
            ...
            {
                AddToListProcess("Client disconnected.");
                ...
                if (m_clientSockets.Count == 1)
                {
                    ...
                    m_game = new Game();
                    m_gameStarted = false;
                    AddToListProcess("New game state has been started!");
                    return;
                }
        ...
        private void SendCallback(IAsyncResult AR)
        {
            ...
            {
                AddToListProcess("Error in SendCallback");
            }
        }
